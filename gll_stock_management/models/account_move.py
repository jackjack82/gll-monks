...
class AccountMove(models.Model):
    ...
    def _compute_services_totals(self):
        ...
        for move in self:
            ...
            service_for_single_id, service_for_box_id = sp_obj.get_single_box_product_services()
            ...
            move.logistics_total = move.logistics_services + move.fixed_fee + move.preparation
