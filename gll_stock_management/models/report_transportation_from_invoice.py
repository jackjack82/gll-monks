...
class ReportItalyTransportationServicesFromInvoice(models.AbstractModel):
    ...
    def _get_preparation_amount(self, picking):
        ...
        This method is meant to be overridden by company-specific modules.
        
        Args:
            picking: The picking record.
            
        Returns:
            float: The preparation amount.
        """
        return 0.0
