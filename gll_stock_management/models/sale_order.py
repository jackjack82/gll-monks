    ...
    def _generate_and_attach_reports(self, invoice):
        ...
        for report_name in report_names:
            ...
            if "logistics_services" in report_name:
                filename = (
                    f"Fatturazione_Servizi_Logistici_{invoice.name}.pdf"
                )
            elif "trasporto_italia" in report_name:
                filename = (
                    f"Fatturazione_Servizi_Trasporto_Italia_{invoice.name}.pdf"
                )
            else:
                filename = (
                    f"Consuntivo_entrata_merci_{invoice.name}.pdf"
                )
            ...
            invoice.message_post(
                body=(
                    f"Report {filename} automatically generated and attached"
                ),
